...
export default function (bbox) {
  ...
  var nodes,
      ...
      function force () {
        ...
        boundingBoxes = new Array(nodes.length);
        for (i = 0; i < nodes.length; ++i) boundingBoxes[i] = bbox(nodes[i], i, nodes);
            ...
            if (data) {
              ...
              if (data.node.index !== nodeI) {
                ...
                if (nx1 <= dnx2 && dnx1 <= nx2 && ny1 <= dny2 && dny1 <= ny2) {
                  ...
                  var xBPush = xOverlap * strength / bWidth
                  var yBPush = yOverlap * strength / bHeight

                  var xDPush = xOverlap * strength / dWidth
                  var yDPush = yOverlap * strength / dHeight
